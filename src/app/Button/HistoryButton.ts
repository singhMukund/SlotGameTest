...
export class HistoryButton extends Container{
    ...
    private initializeButton() :void{
        this.buttton = new Sprite(this.buttonTexture.textures['history_regular.png']);
    ...
    private onButtonDown() : void{
        ...
        this.buttton.texture = this.buttonTexture.textures['history_pressed.png'];
    }
    ...
    private onButtonUp() :void{
        ...
        this.buttton.texture = this.buttonTexture.textures['history_regular.png'];
    ...
    disable() :void{
        ...
        this.buttton.texture = this.buttonTexture.textures['history_disabled.png'];
