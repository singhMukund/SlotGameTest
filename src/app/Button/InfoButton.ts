...
export class InfoButton extends Container{
    ...
    private initializeButton() :void{
        this.buttton = new Sprite(this.buttonTexture.textures['into_regular.png']);
    ...
    private onButtonDown() : void{
        ...
        this.buttton.texture = this.buttonTexture.textures['into_pressed.png'];
    }
    ...
    private onButtonUp() :void{
        ...
        this.buttton.texture = this.buttonTexture.textures['into_regular.png'];
    ...
    disable() :void{
        ...
        this.buttton.texture = this.buttonTexture.textures['into_disabled.png'];
